    ...
    <AppShell>
      ...
      <div className="relative h-48 md:h-64 overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 flex items-end gap-4">
          <Image src={imageUrl(profile.avatarUrl, 80)} alt={profile.nickname} width={80} height={80} className="w-20 h-20 rounded-full border-4 border-[var(--bg-primary)] object-cover" />
          <div>
